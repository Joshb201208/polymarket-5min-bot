...
class DataFeed:
    ...
    async def screen_universe(
        ...
        filtered = [
            ...
            and "." not in sym       # No class shares like BRK.B (not on Alpaca options)
            and len(sym) <= 5       # Symbols > 5 chars are usually preferred stock or funds
            and sym.isalpha()       # Pure alpha only — no hyphens, numbers in symbol
        ]
