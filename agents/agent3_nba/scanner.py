"""Agent 3 Scanner — finds NBA/basketball markets on Polymarket."""
...
NBA_TAG_SLUGS = ["nba", "basketball"]
NBA_TEXT_QUERIES = ["NBA", "basketball"]


class NBAScanner:
    """Scans Polymarket for NBA/basketball markets."""
    ...
    def scan(self) -> list[dict]:
        """Return list of NBA market candidates."""
        logger.info("Agent 3 — scanning for NBA markets...")
        self.markets_scanned = 0
        ...
        logger.info("Agent 3 — %d NBA candidates from %d markets", len(candidates), self.markets_scanned)
        return candidates
